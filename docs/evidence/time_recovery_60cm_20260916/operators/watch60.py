from ops60 import remote, ROOT
import sys

name=sys.argv[1]
assert name.startswith('codex-time-recovery-60cm-')
remote('RUN_ID='+repr(name)+'\n'+r'''
from pathlib import Path
import hashlib,json,os,subprocess,time,shutil
root=Path('/home/graneple/e2e_autonomous/time_recovery_60cm_20260916');run=root/RUN_ID
