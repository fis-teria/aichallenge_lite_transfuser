...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_preview20_20260917')
raw = native / 'raw/codex-time-timepreview20-lap01'
out = repo / 'docs/evidence/time_preview20_20260917'
