...
result=dict(scope='Observed single ordinary model-driven lap, no perturbation experiment',
    host_status=host['status'], target_speed_kmh=5.0, moving_speed_median_kmh=float(np.median(moving)) if moving else None,
