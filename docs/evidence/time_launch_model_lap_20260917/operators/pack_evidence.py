...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_launch_model_lap_20260917')
raw = native / 'raw/codex-time-launch-lap01'
out = repo / 'docs/evidence/time_launch_model_lap_20260917'
...
for folder in ['evaluation', 'stop_location']:
...
for name in ['host_result.json', 'lap_progress.json', 'trial_config.json', 'drive_authorized.json',
             'control_heartbeat.json', 'inference_heartbeat.json', 'transfer_manifest.json']:
