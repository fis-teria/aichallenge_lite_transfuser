...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_path_dev_20260917')
raw = native / 'raw/codex-time-dev-lap01'
out = repo / 'docs/evidence/time_path_dev_20260917'
