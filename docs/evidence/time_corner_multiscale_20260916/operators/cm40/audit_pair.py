...
out=Path('/home/thistle/e2e_autonomous/runs/time_corner_multiscale40_20260916')
raw=Path('/home/thistle/e2e_autonomous/raw/time_corner_multiscale40_20260916')
proof=json.loads((out/f'corner40_pair{PAIR:02}_20260916_verified.json').read_text())
