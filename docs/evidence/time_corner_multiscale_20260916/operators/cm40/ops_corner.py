...
ROOT='/home/graneple/e2e_autonomous/time_recovery_corner40_20260916'
OUT='/home/thistle/e2e_autonomous/runs/time_corner_multiscale40_20260916'
RAW='/home/thistle/e2e_autonomous/raw/time_corner_multiscale40_20260916'
...
for side,domain,nodes,sim,split in [('left',1,'0-3','8-9,12-15','train'),('right',2,'4-7','10-11,16-19','validation')]:
 ...
 name=f'codex-time-recovery-corner40-p{PAIR:02}-d{domain}'
...
def ship(pair):
    ...
    transport.ship(pair,prefix=f'corner40_pair{pair:02}_20260916')
