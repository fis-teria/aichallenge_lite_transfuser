...
ROOT='/home/graneple/e2e_autonomous/time_recovery_corners_20260916'
OUT='/home/thistle/e2e_autonomous/runs/time_corner_recovery_20260916'
...
def ship(pair):
    ...
    transport.ship(pair,prefix=f'corners_pair{pair:02}_20260916')
