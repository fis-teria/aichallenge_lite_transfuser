...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_launch_10kmh_20260917')
raw = native / 'raw/codex-time-launch10-lap02'
out = repo / 'docs/evidence/time_launch_10kmh_20260917'
...
for folder in ['evaluation', 'stop_location', 'baseline_replay']:
...
aborted = native.parent/'time_launch_10kmh_recording_abort_20260917'
for name in ['shipping.json','transfer_verification.json','awsim_preserved.json','post_environment.json',
             'evaluation/summary.json','raw/codex-time-launch10-lap01/host_result.json',
             'raw/codex-time-launch10-lap01/video_recording.json']:
    copy(aborted/name,out/'aborted_recording_attempt'/Path(name).name)
