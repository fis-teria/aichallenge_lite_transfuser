...
from aic_transfuser_lite.control.curvature_support_v2 import FIVE_KMH_STOPPING_SPEED
from aic_transfuser_lite.control.vehicle_motion_v1 import AWSIM_10KMH_POLICY

base=Path('/home/thistle/e2e_autonomous/runs')
raw=base/'time_launch_10kmh_20260917/raw/codex-time-launch10-lap02'
out=base/'time_launch_10kmh_stop5_20260917'
...
try:
    check_turning_scan(*args,**kwargs)
except ValueError as exc:
    assert str(exc)=='STOPPING_SWEEP_OCCUPIED'
else:
    raise AssertionError('previous rejection did not replay')
diagnostic=check_turning_scan(*args,**kwargs,stopping_distance_policy=FIVE_KMH_STOPPING_SPEED)
