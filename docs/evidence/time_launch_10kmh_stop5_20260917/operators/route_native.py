...
old = root.parent / 'time_launch_10kmh_20260917/raw/codex-time-launch10-lap02'
...
ax.plot(*(xy-origin).T, color='#246cac', linewidth=2, label='10 km/h, 5 km/h scan horizon: actual trace')
ax.scatter(*(old_xy-origin), marker='X', color='#d48a20', s=100, zorder=5, label='Previous 10 km/h guard at 44.95 m')
