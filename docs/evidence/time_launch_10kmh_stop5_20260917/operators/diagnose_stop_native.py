...
from aic_transfuser_lite.control.curvature_support_v2 import curvature_support_envelope, stopping_envelope_parameters, FIVE_KMH_STOPPING_SPEED
...
root=Path('/home/thistle/e2e_autonomous/runs/time_launch_10kmh_stop5_20260917')
raw=root/'raw/codex-time-launch10-stop5-lap01'
...
travel,lateral_padding,diagnostic=stopping_envelope_parameters(speed,motion,stopping_distance_policy=FIVE_KMH_STOPPING_SPEED)
...
proof=scan_margin(scan,sensor,speed_mps=speed,measured_rad=guard['measured_steer_rad'],issued_rad=guard['issued_steer_rad'],
    previous_rad=guard['previous_steer_rad'],yaw_rate_radps=obs['heading_rate_radps'],lateral_mps=obs['reported_lateral_mps'],vehicle_model_policy=AWSIM_10KMH_POLICY,stopping_distance_policy=FIVE_KMH_STOPPING_SPEED)
