...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_launch_10kmh_stop5_20260917')
raw = native / 'raw/codex-time-launch10-stop5-lap01'
out = repo / 'docs/evidence/time_launch_10kmh_stop5_20260917'
