...
from aic_transfuser_lite.data.time_dataset_v1 import TimeDatasetConfig, _eligible, _pose_anchor
...
def audit(name,split):
    ...
    report['three_event_qualified']=(report['all_planned_recovered'] and all(e.get('accepted_camera_anchors',0)>=60 and e.get('target_band_camera_anchors',0)>0 for e in events))
