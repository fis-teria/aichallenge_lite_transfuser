...
for suffix,source in [('close10-on-a01','cone-close6-a02'),('close10-control-a01','cone-close6-a02'),('normal10-on-a01','cone-b01')]:
    name='lidar-v45-pc10-front-'+suffix
    source='lidar-v45-pc10-front-'+source
    p=old/'scenarios'/(source+'.yaml')
    scenario=yamlio.load_file(p)
    scenario['name']=name
    scenario['description']='MPPI V45 teacher 10 km/h target; same placement and spawn as 5 km/h comparison.'
