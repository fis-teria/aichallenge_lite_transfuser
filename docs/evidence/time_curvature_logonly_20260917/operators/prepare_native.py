...
out=base/'runs/time_curvature_logonly_20260917';out.mkdir(exist_ok=False)
...
record=dict(status='PASS',exit=0,source_commit=head,tested_source_commit=head,
    ...
    runtime_contract_valid=True,predictions=rows,runtime_speed_profile_changed=False,scan_proximity_log_only=True,stopping_distance_diagnostic=True,sealed_test_read=False,
