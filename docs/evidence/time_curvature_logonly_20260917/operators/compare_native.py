...
out=base/'time_curvature_logonly_20260917/evaluation'
trials=[('Fixed 10 km/h','time_launch_10kmh_stop1m_20260917','codex-time-launch10-stop1m-lap01'),
        ...
        ('Adaptive + proximity logging only','time_curvature_logonly_20260917','codex-time-curve15-logonly-lap03')]
results=[];fig,axes=plt.subplots(4,1,figsize=(12,11),sharex=False)
new_active=[]
...
record=dict(scope='FOUR_SINGLE_SAME_SCENE_RUNS_NOT_REPEATED_SUCCESS_RATE',trials=results,
