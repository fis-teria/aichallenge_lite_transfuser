...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_curvature_logonly_20260917')
raw = native / 'raw/codex-time-curve15-logonly-lap03'
out = repo / 'docs/evidence/time_curvature_logonly_20260917'
