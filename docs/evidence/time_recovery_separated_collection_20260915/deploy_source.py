...
old = 'd269b1bd67ab4158b0d9593f42106b2fcb1edf4b'
...
assert paths == ["src/aic_transfuser_lite/data/time_nominal_steering_guide_v1.py"]
...
assert not json.loads((root/'campaign_20260914.json').read_text())['attempts']
