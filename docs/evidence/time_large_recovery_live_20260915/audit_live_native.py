...
def audit(name,split):
    ...
    report['increase_eligible']=(report['all_planned_recovered'] and all(e.get('accepted_camera_anchors',0)>=60 and e.get('target_band_camera_anchors',0)>0 for e in events))
