...
NAMES = ['codex-time-recovery-large-live-g03-left-r04',
         'codex-time-recovery-large-live-g03-right-r03',
         'codex-time-recovery-large-live-g05-left-r01']
...
def main() -> None:
    ...
    colors = dict(P00='#1264ab', S00='#bb4b00', P02='#16825d', P03='#963caa', P04='#756500')
    provenance = {}
    for ax, name in zip(axes, NAMES):
        ...
        low, high = sorted([sign * .15, sign * .25])
        ax.axhspan(low, high, color='#dce8f0', alpha=.85, label='15-25 cm target band')
        ...
        short = name.removeprefix('codex-time-recovery-large-live-')
