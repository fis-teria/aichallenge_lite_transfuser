"""Two finite 0.10 rad calibration attempts; gate further collection in native WSL."""
...
ROOT = Path('/home/graneple/e2e_autonomous/time_recovery_pulse_a010_20260914')
REFERENCE_HASHES = {
...
def main() -> None:
    ...
    old_root = ROOT.parent/'time_recovery_pulse_plateau_20260914'
    ...
    assert not ledger['sealed'] and ledger['scope'] == 'CALIBRATION_ONLY'
