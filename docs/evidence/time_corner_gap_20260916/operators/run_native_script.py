...
assert source.name in ('adaptive_plan.py', 'adaptive_plan_v2.py', 'adaptive_plan_v3.py', 'finalize_native.py', 'inspect_pair.py', 'entry_calibration.py', 'diagnose_failures.py')
