...
expected='62dbe8b1f6c3c62e558222a4bcd85c4c44adae67'
...
for name,extra in [('focused_62dbe8b.log',['tests/test_time_recovery_map_body_v1.py','tests/test_time_large_recovery_reference_v1.py','tests/test_time_corner_recovery_v1.py','tests/test_time_large_recovery_v1.py']),('full_62dbe8b.log',[])]:
 log=out/name
...
with (out/'test_gate_62dbe8b.json').open('x') as f:json.dump(dict(commit=expected,full_exit=0,log=str(log),log_sha256=hashlib.sha256(log.read_bytes()).hexdigest()),f,indent=2)
