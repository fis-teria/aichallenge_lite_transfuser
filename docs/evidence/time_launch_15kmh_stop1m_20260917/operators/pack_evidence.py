...
repo = here.parents[1]
native = Path(r'\\wsl.localhost\Ubuntu-22.04-Recovered\home\thistle\e2e_autonomous\runs\time_launch_15kmh_stop1m_20260917')
raw = native / 'raw/codex-time-launch15-stop1m-lap01'
out = repo / 'docs/evidence/time_launch_15kmh_stop1m_20260917'
