...
ROOT = '/home/graneple/e2e_autonomous/time_launch_15kmh_stop1m_20260917'
WSL = '/home/thistle/e2e_autonomous/runs/time_launch_15kmh_stop1m_20260917'
...
CONFIG = 'configs/control/time_path_launch_15kmh_stop1m_20260917.json'
RUN_ID = 'codex-time-launch15-stop1m-lap01'
...
command=['timeout','--signal=TERM','--kill-after=10s','710s','python3',str(root/manifest['source_dir']/'tools/run_time_path_awsim_trial.py'),'--deployment',str(root),'--run-id',{RUN_ID!r},'--display',':0','--config',{CONFIG!r},'--record-video']
