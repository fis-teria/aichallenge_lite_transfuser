...
ax.plot(*(xy-origin).T, color='#246cac', linewidth=2, label='15 km/h, 1 m scan horizon: actual trace')
...
ax.set(xlabel='Map X relative to launch [m]', ylabel='Map Y relative to launch [m]',
       title=f"{summary['status']} | Recorded travel {travel:.1f} m | Target 15 km/h")
