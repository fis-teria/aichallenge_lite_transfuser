...
out=base/'time_curvature_preview_20260917/evaluation'
trials=[('Fixed 10 km/h','time_launch_10kmh_stop1m_20260917','codex-time-launch10-stop1m-lap01'),
        ...
        ('Adaptive, ceiling 15 km/h','time_curvature_preview_20260917','codex-time-curve15-lap01')]
...
for ax,(label,name,run_id) in zip(axes,trials):
    ...
    if preview:
        ...
        assert result['normal_acceleration_range_mps2'][1]<=.4+1e-9
