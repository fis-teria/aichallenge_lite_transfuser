...
old = root.parent / 'time_launch_10kmh_stop5_20260917/raw/codex-time-launch10-stop5-lap01'
...
ax.plot(*(xy-origin).T, color='#246cac', linewidth=2, label='10 km/h, 1 m scan horizon: actual trace')
ax.scatter(*(old_xy-origin), marker='X', color='#d48a20', s=100, zorder=5, label='Previous 5 km/h horizon guard at 202.37 m')
...
ax.set(xlabel='Map X relative to launch [m]', ylabel='Map Y relative to launch [m]',
       title=f"{summary['status']} | Recorded travel {travel:.1f} m | Target 10 km/h")
