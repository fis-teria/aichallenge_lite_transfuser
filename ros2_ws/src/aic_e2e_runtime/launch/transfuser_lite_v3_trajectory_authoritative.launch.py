...
def generate_launch_description() -> LaunchDescription:
    ...
    inference = Node(
        ...
        name="aic_transfuser_inference_v3_trajectory_authoritative",
        output="screen",
        ...
        remappings=remappings + [("nominal_control_cmd", "/nominal_control_cmd")],
    )
    safety = Node(
        package="aic_e2e_runtime",
        executable="safety_supervisor_node",
        name="aic_safety_supervisor_v3_trajectory_authoritative",
        output="screen",
        parameters=[LaunchConfiguration("param_file"), {
            "use_sim_time": LaunchConfiguration("use_sim_time"),
        }],
    ...
    rviz = Node(
        package="rviz2",
        executable="rviz2",
        name="v3_trajectory_authoritative_rviz",
        output="screen",
