...
project='codex-pp-speed20-lap-13'
...
prior=AttemptBudget(Path('/home/graneple/e2e_autonomous/pp_reference_lap_12/budget.json'))
...
try:
    ...
    cmd=['make','dev','CONTROL_METHOD=pure_pursuit','CAPTURE=false','ROSBAG=false','AWSIM_LAPS=1',
         'RUN_ID=pp_speed20_lap_13','OUTPUT_HOST_ROOT='+str(out)]
    result['command']=cmd
